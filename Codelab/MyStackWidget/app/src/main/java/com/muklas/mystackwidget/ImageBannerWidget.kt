package com.muklas.mystackwidget
...
class ImageBannerWidget : AppWidgetProvider() {
    ...
    companion object{
        private const val TOAST_ACTION = "com.muklas.mystackwidget.TOAST_ACTION"
        const val EXTRA_ITEM = "com.muklas.mystackwidget.EXTRA_ITEM"
