package com.muklas.mystacknotif
...
class MainActivity : AppCompatActivity() {
    ...
    companion object {
        private const val CHANNEL_NAME = "notif channel"
    ...
    private fun sendNotif() {
        ...
        val largeIcon =
            BitmapFactory.decodeResource(resources, R.drawable.ic_notifications_white_24dp)
