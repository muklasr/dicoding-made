package com.muklas.mycustomnotif
...
import com.muklas.mycustomnotif.NotificationService.Companion.CHANNEL_ID
import com.muklas.mycustomnotif.NotificationService.Companion.CHANNEL_NAME
import com.muklas.mycustomnotif.NotificationService.Companion.REPLY_ACTION
...
class NotificationBroadcastReceiver : BroadcastReceiver() {
    ...
    override fun onReceive(context: Context, intent: Intent) {
        if (REPLY_ACTION == intent.action) {
            ...
            val notifyId = intent.getIntExtra(KEY_NOTIFICATION_ID, 0)
